...
function (_Modal) {
  ...
  _proto.dropdownIconMatches = function dropdownIconMatches(search) {
    var _this3 = this;
    ...
    return inputIcon.length && iconState.matches.length > 0 && !(iconState.matches.length == 1 && iconState.matches[0] === inputIcon) ? m("ul", {
      ...
      return m("li", {
        ...
        onclick: function onclick(e) {
          return _this3.input.icon(icon);
        }
      }, m("icon", {
        className: "Chat-FullColor"
      }, m("i", {
        className: icon
      })), m("span", null, flarum_helpers_highlight__WEBPACK_IMPORTED_MODULE_6___default()(icon, inputIcon)));
    })) : null;
  };
...
function (_Page) {
  ...
  _proto.onupdate = function onupdate(vnode) {
    ...
    if (this.listOpen()) {
      ...
      console.log(this.element.querySelector('.ChatPage--list'), this.element.querySelector('.ChatPage--list').style.height, document.documentElement.clientHeight - this.element.querySelector('.ChatPage--list').getBoundingClientRect().top);
    }
  };
...
function (_Search) {
  ...
  _proto.view = function view(vnode) {
    ...
    if (!((_this$state$getValue = this.state.getValue()) == null ? void 0 : _this$state$getValue.length)) {
