...
var ChatHeader = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view(vnode) {
    ...
    })) : '', m("h2", null, app.chat.getCurrentChat() ? [app.chat.getCurrentChat().icon() ? m("i", {
  ...
  _proto.toggleChat = function toggleChat(e) {
    var showing = !app.chat.getFrameState('beingShown');
...
var ChatInput = /*#__PURE__*/function (_Component) {
  ...
  _proto.inputProcess = function inputProcess(e) {
    ...
    this.state.input.rows = Math.min(input.scrollHeight / input.lineHeight, app.screen() === 'phone' ? 3 : 5);
...
var ChatFrame = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view(vnode) {
    ...
    return m("div", {
      ...
      className: "list"
    }, app.chat.getChatsSortedByLastUpdate().map(function (model) {
      return m("div", {
        onclick: app.chat.onChatChanged.bind(app.chat, model)
      }, m(_ChatPreview__WEBPACK_IMPORTED_MODULE_3__["default"], {
        key: model.id(),
        model: model
      }));
    }), app.session.user && app.chat.getPermissions().create.chat ? m("div", {
      "class": "panel-add",
      onclick: function onclick() {
...
var ChatModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.componentFormIcon = function componentFormIcon(options) {
    ...
    return [options.title ? m("label", null, options.title) : null, m("div", null, options.desc ? m("label", null, options.desc) : null, m("div", {
      ...
      className: (_this$input$icon = this.input.icon()) != null && _this$input$icon.length ? this.input.icon() : 'fas fa-bolt'
    }))))];
  };
...
var ChatPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.view = function view() {
    ...
    }, m("ul", null, flarum_helpers_listItems__WEBPACK_IMPORTED_MODULE_4___default()(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.sidebarItems().toArray()))), m(_ChatHeader__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
var ChatViewport = /*#__PURE__*/function (_Component) {
  ...
  _proto.onupdate = function onupdate(vnode) {
    ...
    var model = this.attrs.chatModel;
  ...
  _proto.wrapperOnCreate = function wrapperOnCreate(vnode) {
    ...
    if (!app.current.matches(_ChatPage__WEBPACK_IMPORTED_MODULE_9__["default"]) && app.screen() !== 'phone') vnode.dom.style.height = app.chat.getFrameState('transform').y + 'px';
  };
...
var ChatWelcome = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view(vnode) {
    return m("div", null, m("div", {
      ...
      className: "welcome"
    }, m("h1", null, app.translator.trans('xelson-chat.forum.chat.welcome.header')), m("span", null, app.translator.trans('xelson-chat.forum.chat.welcome'))) : null));
  };
